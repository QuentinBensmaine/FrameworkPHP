...
class Skill_userController extends Controller
{
    ...
    public function destroy(Request $request)
    {
        ...
        $a = Skill_user::join("skills","skill_user.skill_id","skills.id")->join("users","skill_user.user_id","users.id")->where("skill_user.user_id", 51)->where("skill_user.skill_id",$request->id)->delete();
        return $request;
    }
}
